...
public class SubmissionDisplay extends javax.swing.JFrame
{
    ...
    UserDashboard temp;
    public SubmissionDisplay(UserSocket userSocket, UserDashboard dashboard)
    {
        initComponents();
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) 
            {
                if (evt.getClickCount() == 1 && !evt.isConsumed()) 
                {
                    ...
                    if (row >= 0 && col == 2) 
                    {
                        ...
                        String tempo = tablemodel.getValueAt(row, 2).toString();
    ...
    private void initComponents()
    {
        ...
        CopyButton.setFont(new java.awt.Font("Product Sans", 1, 16)); // NOI18N
        ...
        SourceCodeLabel.setForeground(new java.awt.Color(255, 0, 0));
        ...
        closeButton1.setFont(new java.awt.Font("Product Sans", 1, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(SubDetailsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 1019, Short.MAX_VALUE)
                .addContainerGap())
